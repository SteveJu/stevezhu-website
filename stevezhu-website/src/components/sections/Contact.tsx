  ...
  return (
    <section id="contact" className="py-32 relative">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-violet-500/5 rounded-full blur-[128px]" />
      </div>
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="mt-10">
            <a
              ...
              className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-violet-600 to-cyan-600 text-white font-medium rounded-xl hover:from-violet-500 hover:to-cyan-500 transition-all shadow-lg shadow-violet-500/20 hover:shadow-violet-500/30"
            >
